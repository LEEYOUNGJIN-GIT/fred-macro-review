...
> Data as-of: 2026-07-03 (oldest: 2026-06-26 ^VIX3M)
> ⚠ **Stale**: oldest data is 7d old (>5d) — fetch may be failing
> Generated: 2026-07-03 22:00:13 UTC

## 신호 요약

| # | 신호 | 상태 | 값 | 핵심 요약 |
|---|------|------|-----|----------|
| 1 | 한국 주식 | 🟢 견조 | 81.3000 | KOSPI YoY=+153.09%, KOSDAQ YoY=+9.50%, KOSPI 4W=-11.47% |
...
| 4 | VIX Term | 🟢 contango | 0.8241 | VIX3M=20.13, VIX/VIX3M=0.8241 (FRED VIXCLS/^VIX3M), VIX3M 4W Δ=+1.02 |
...
### 🟢 한국 주식 — 견조
- **값**: 81.3
- **상세**: KOSPI YoY=+153.09%, KOSDAQ YoY=+9.50%, KOSPI 4W=-11.47%
- **시리즈**: ^KS11, ^KQ11
...
### 🟢 VIX Term — contango
- **값**: 0.8241
- **상세**: VIX3M=20.13, VIX/VIX3M=0.8241 (FRED VIXCLS/^VIX3M), VIX3M 4W Δ=+1.02
- **시리즈**: ^VIX3M, VIXCLS
