...
Generated at: 2026-08-08 21:52:02 UTC
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | WB_KR_CPI | 물가 | 한국 CPI 인플레이션 | Korea CPI Inflation | A | % | World Bank |
| 2 | WB_US_CPI | 물가 | 미국 CPI 인플레이션 | US CPI Inflation | A | % | World Bank |
| 3 | WB_KR_UNEMP | 노동 | 한국 실업률 | Korea Unemployment Rate | A | % | World Bank |
| 4 | WB_US_UNEMP | 노동 | 미국 실업률 | US Unemployment Rate | A | % | World Bank |
| 5 | OECD_KR_CLI | 선행지수 | 한국 OECD CLI | OECD CLI Korea | M | Index | OECD |
| 6 | OECD_US_CLI | 선행지수 | 미국 OECD CLI | OECD CLI USA | M | Index | OECD |
| 7 | OECD_DEU_CLI | 선행지수 | 독일 OECD CLI | OECD CLI Germany | M | Index | OECD |
| 8 | IMF_KR_CURRENT_ACCOUNT | 대외 | 한국 경상수지 | Korea Current Account Balance | Q | USD | IMF |
| 9 | ECB_EURUSD | 금융 | EUR/USD | EUR/USD Exchange Rate | D | USD/EUR | ECB |
| 10 | ECB_POLICY_RATE_MRO | 금융 | ECB MRO 금리 | ECB Main Refinancing Rate | M | % | ECB |
...
| 지표 | 주기 | 최신값 | 기준일 | 전기비 | 중기비 | YoY비 |
| --- | --- | --- | --- | --- | --- | --- |
| EUR/USD | D | 1.15 | 2026-08-07 | -0.00 | +0.01 | -0.01 |
